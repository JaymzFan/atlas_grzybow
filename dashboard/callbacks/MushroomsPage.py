...
def register_callbacks(dash_app):
    @dash_app.callback(
        Output("mushrooms_viewer_data", "data"), Input("url", "pathname")
    )
    ...
    @dash_app.callback(
        Output("mushrooms_viewer_current_view", "data"),
        [
    ...
    @dash_app.callback(
        Output("dropdown_mushroom_option", "value"),
        [
            Input("mushrooms_viewer_data", "data"),
            Input("previous_mushroom", "n_clicks"),
            Input("next_mushroom", "n_clicks"),
    ...
    @dash_app.callback(
        [Output("previous_mushroom", "disabled"), Output("next_mushroom", "disabled")],
    ...
    @dash_app.callback(
        Output("dropdown_mushroom_option", "options"),
        Input("mushrooms_viewer_data", "data"),
    )
    def dropdown_options(data):
        ...
        available_mushrooms = [
            {"label": x[1]["MushroomNameInFormal"], "value": x[0]}
    ...
    @dash_app.callback(
        Output("mushroom_toxic_badge", "children"),
        Input("mushrooms_viewer_current_view", "data"),
    )
    ...
    @dash_app.callback(
        Output("mushroom-card", "color"), Input("mushrooms_viewer_current_view", "data")
    )
    ...
    @dash_app.callback(
        Output("curr_mushroom_imgs", "items"),
        Input("mushrooms_viewer_current_view", "data"),
    )
    def imgs_view(data):
        if data is None:
    ...
    @dash_app.callback(
        Output("collapse-mush-info", "is_open"),
