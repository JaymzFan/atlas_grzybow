...
modify_loc_card = dbc.Form(
    [
        dbc.Row(
            [
                dbc.Label("Nazwa"),
                dbc.Col([dbc.Input(type="text", id="modify-loc-name")]),
            ],
            className="mb-3",
        ),
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        dbc.Textarea(
                            id="modify-loc-information", style={"height": "8rem"}
                        )
                    ]
                ),
            ],
            ...
            [
                ...
                dbc.Col(
                    [
                        dbc.Input(
                            type="number",
                            id="modify-loc-radius-in-meters",
                            debounce=True,
                        )
                    ]
                ),
        ...
        dbc.Row(
            [
                dbc.Alert(
                    "Dane lokalizacji zostały zaktualizowane",
        ...
        dbc.Row(
            [
                dbc.Alert(
                    "Lokalizacja została usunięta z bazy danych",
    ...
    [
        dbc.Row(
            dbc.Col(
                html.Div(
                    dbc.Button(
                        "Zastosuj filtry", id="locations_apply_filters", color="success"
                    ),
                    className="py-1",
                )
            )
                ...
                [
                    html.Div(
                        [
                            ...
                            dbc.Button(
                                "Zaznacz grzyby sezonowe",
                                id="button-mark-sesonal-mushrooms",
                                className="py-1",
                            ),
                            dbc.Checklist(
                                options=[],
...
main_page = dbc.Container(
    [
        ...
        dbc.Row(
            dbc.Col(html.Div([locations_map]), xl=8, lg=8, md=12, sm=12),
            justify="center",
        ),
        dbc.Row(
            dbc.Col(
                dbc.Button(
                    "Pokaż filtry lokalizacji",
                    id="locations_show_filters",
                            ...
                            dbc.AccordionItem(
                                [
                                    dbc.Tabs(
                                        [
                                            dbc.Tab(
                                                clicked_loc_card, label="Szczegóły"
                                            ),
                                            dbc.Tab(
                                                modify_loc_card,
                                                label="Modyfikuj",
                                    ...
                                    dbc.Row(
                                        dbc.Col(
                                            dbc.Alert(
                                                ...
                                                id="alert-setting-ppl-to-share-loc",
                                                is_open=False,
                                                duration=3000,
                                            )
                                        )
...
add_new_loc_card = dbc.Form(
    [
        dbc.Row(
            [dbc.Label("Położenie"), dbc.Col([], id="add_new_loc_info")],
            className="mb-3",
        ),
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        dbc.Input(
                            type="number",
                            id="loc-addnew-radius-in-meters",
                            debounce=True,
                        )
                    ]
                ),
        ...
        dbc.Row(
            [
                dbc.Label("Nazwa"),
                dbc.Col([dbc.Input(type="text", id="addnew-loc-name", debounce=True)]),
            ],
            className="mb-3",
        ),
        dbc.Row(
            [
                ...
                dbc.Col(
                    [
                        dbc.Textarea(
                            id="addnew-loc-information", style={"height": "8rem"}
                        )
                    ],
                    className="mb-3",
                ),
        ...
        dbc.Row(
            [
                dbc.Alert(
                    "Lokalizacja została dodana do bazy danych",
...
manage = dbc.Container(
    [
        ...
        dbc.Row(
            dbc.Col([add_new_loc_card], xl=8, lg=8, md=12, sm=12), justify="center"
        ),
    ],
    fluid=True,
)
